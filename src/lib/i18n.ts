...
const t = {
  es: {
    ...
    platform_tagline: 'Plataforma de Analytics Apotex',
    sidebar_tagline: 'Analytics & Entrenamiento',
    ...
    nav_roleplay_group: 'Bridge Analytics',
    ...
    page_roleplay_title: 'Analytics Avanzado',
  ...
  en: {
    // Branding
    platform_tagline: 'Apotex Analytics Platform',
    sidebar_tagline: 'Analytics & Training',
