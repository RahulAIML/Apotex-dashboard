 ...
 * server.js applies on the Node deployment.
 *
 ...
 */
const ROUTES = {
  'apotex-api': (rest) => `https://serv.aux-rolplay.com/apotex/api/${rest}`,
  bridge: (rest) => `https://serv.aux-rolplay.com/apotex/bridge/${rest}`,
}
